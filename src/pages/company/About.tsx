...
const About = () => {
  return (
    <Layout className="-mt-16">
          ...
          <div className="space-y-12 md:space-y-20 text-center">
            <div className="space-y-8 md:space-y-12">
              <div className="inline-block px-5 py-2 bg-pearl/10 rounded-full backdrop-blur-sm">
                <span className="text-xs md:text-sm uppercase tracking-[0.15em] text-pearl/60 font-medium">Made in India • Made with Care</span>
              </div>

              <h1 className="text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-light text-pearl leading-[0.95] tracking-tight px-4">
                The Energy
                <br />
                That Cares.
              </h1>
              ...
              <div className="space-y-6 max-w-4xl mx-auto px-4">
                <p className="text-xl md:text-2xl lg:text-3xl text-pearl/60 font-light leading-[1.6]">
                  NESS isn't just about electricity — it's about empathy, reliability, and belonging.
                </p>
                <p className="text-lg md:text-xl text-pearl/40 italic font-light leading-relaxed">
      ...
      <section className="py-20 md:py-32 lg:py-40 bg-graphite">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center mb-16 md:mb-24 lg:mb-32 space-y-6 md:space-y-8">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-pearl/60 font-light max-w-3xl mx-auto leading-[1.7] px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
            ...
            <AnimatedCard hover="lift" className="bg-pearl/[0.03] border border-pearl/10 rounded-2xl overflow-hidden group">
              {/* Image Placeholder */}
              <div className="aspect-[4/3] bg-gradient-to-br from-pearl/5 to-pearl/10 relative overflow-hidden">
                {/* Placeholder: peaceful Indian home interior with NESS battery integrated */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <Heart className="w-16 h-16 text-pearl/10" />
                </div>
              </div>
              ...
              <div className="p-8 md:p-10 space-y-5">
                ...
                <h3 className="text-xl md:text-2xl font-light text-pearl leading-tight">Care for Homes</h3>
                <p className="text-base md:text-lg text-pearl/70 leading-[1.7]">
                ...
                <div className="text-sm text-pearl/40 pt-3 border-t border-pearl/10 italic">
            ...
            {/* Care for Partners */}
            <AnimatedCard hover="lift" delay={100} className="bg-pearl/[0.03] border border-pearl/10 rounded-2xl overflow-hidden group">
              {/* Image Placeholder */}
              <div className="aspect-[4/3] bg-gradient-to-br from-pearl/5 to-pearl/10 relative overflow-hidden">
                {/* Placeholder: installer team on rooftop solar installation */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <Users className="w-16 h-16 text-pearl/10" />
                </div>
              </div>

              <div className="p-8 md:p-10 space-y-5">
                <div className="w-12 h-12 rounded-full bg-pearl/10 flex items-center justify-center">
                  <Users className="w-6 h-6 text-pearl" />
                </div>
                <h3 className="text-xl md:text-2xl font-light text-pearl leading-tight">Care for People Who Power Others</h3>
                <p className="text-base md:text-lg text-pearl/70 leading-[1.7]">
            ...
            {/* Care for Planet */}
            <AnimatedCard hover="lift" delay={200} className="bg-pearl/[0.03] border border-pearl/10 rounded-2xl overflow-hidden group">
              {/* Image Placeholder */}
              <div className="aspect-[4/3] bg-gradient-to-br from-pearl/5 to-pearl/10 relative overflow-hidden">
                {/* Placeholder: green landscape with solar panels */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <Globe className="w-16 h-16 text-pearl/10" />
                </div>
              </div>

              <div className="p-8 md:p-10 space-y-5">
                <div className="w-12 h-12 rounded-full bg-pearl/10 flex items-center justify-center">
                  <Globe className="w-6 h-6 text-pearl" />
                </div>
                <h3 className="text-xl md:text-2xl font-light text-pearl leading-tight">Care for the Planet</h3>
                <p className="text-base md:text-lg text-pearl/70 leading-[1.7]">
              ...
              <div className="grid grid-cols-2 gap-6 md:gap-8 pt-8">
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-3xl md:text-4xl font-light tabular-nums"><AnimatedCounter value={23} duration={1500} /></div>
                  </div>
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-3xl md:text-4xl font-light tabular-nums"><AnimatedCounter value={847000} duration={2500} />+</div>
                  </div>
                  <div className="text-xs md:text-sm text-pearl/60 uppercase tracking-[0.12em]">
                    Test cycles run
                  </div>
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-3xl md:text-4xl font-light tabular-nums"><AnimatedCounter value={12} duration={1800} /></div>
                  </div>
                  <div className="text-xs md:text-sm text-pearl/60 uppercase tracking-[0.12em]">
                    AI models deployed
                  </div>
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-3xl md:text-4xl font-light tabular-nums">₹<AnimatedCounter value={47} duration={2000} />Cr</div>
                  </div>
                  <div className="text-xs md:text-sm text-pearl/60 uppercase tracking-[0.12em]">
                    Annual R&D spend
                  </div>
      ...
      <section className="py-20 md:py-32 lg:py-40 bg-charcoal relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-16">
            <div className="text-center space-y-4 md:space-y-5 p-6 rounded-2xl bg-pearl/[0.03]">
              <div className="text-5xl md:text-6xl lg:text-7xl font-light text-pearl tabular-nums">
                <AnimatedCounter value={10} duration={2000} />K+
              </div>
              <div className="text-xs md:text-sm uppercase tracking-[0.15em] text-pearl/50 font-medium">Systems deployed</div>
              <p className="text-xs md:text-sm text-pearl/40 leading-relaxed pt-1 italic">
            ...
            <div className="text-center space-y-4 md:space-y-5 p-6 rounded-2xl bg-pearl/[0.03]">
              ...
              <div className="text-xs md:text-sm uppercase tracking-[0.15em] text-pearl/50 font-medium">MWh delivered</div>
              <p className="text-xs md:text-sm text-pearl/40 leading-relaxed pt-1 italic">
            ...
            <div className="text-center space-y-4 md:space-y-5 p-6 rounded-2xl bg-pearl/[0.03]">
              ...
              <div className="text-xs md:text-sm uppercase tracking-[0.15em] text-pearl/50 font-medium">Cycles proven</div>
              <p className="text-xs md:text-sm text-pearl/40 leading-relaxed pt-1 italic">
            ...
            <div className="text-center space-y-4 md:space-y-5 p-6 rounded-2xl bg-pearl/[0.03]">
              ...
              <div className="text-xs md:text-sm uppercase tracking-[0.15em] text-pearl/50 font-medium">System uptime</div>
              <p className="text-xs md:text-sm text-pearl/40 leading-relaxed pt-1 italic">
          ...
          <div className="mt-20 md:mt-28 aspect-[21/9] bg-gradient-to-br from-pearl/5 to-pearl/10 rounded-3xl overflow-hidden relative">
            {/* Placeholder: panoramic shot of Indian homes with NESS installations */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center space-y-4 p-8">
                <p className="text-2xl md:text-3xl lg:text-4xl text-pearl/30 font-light italic leading-[1.6] max-w-3xl">
      ...
      <section className="py-20 md:py-32 lg:py-40 bg-graphite">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 mb-16 md:mb-24">
            ...
            {/* Mission */}
            <div className="bg-pearl/[0.03] border border-pearl/10 rounded-3xl p-8 md:p-10 lg:p-12 space-y-6 md:space-y-8">
              <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-pearl/10 flex items-center justify-center">
                <Heart className="w-7 h-7 md:w-8 md:h-8 text-pearl" />
              </div>
              <h3 className="text-2xl md:text-3xl lg:text-4xl font-light text-pearl">Our Promise</h3>
              <div className="space-y-5 md:space-y-6 text-pearl/70 leading-[1.7]">
                <p className="text-base md:text-lg">
                  <strong className="text-pearl font-medium">To Customers:</strong><br />
                  Peace of mind, powered effortlessly.
                </p>
                <div className="h-px bg-pearl/10"></div>
                <p className="text-base md:text-lg">
                  <strong className="text-pearl font-medium">To Partners:</strong><br />
                  Systems that work the first time, and every time after.
                </p>
                <div className="h-px bg-pearl/10"></div>
                <p className="text-base md:text-lg">
                  <strong className="text-pearl font-medium">To the Planet:</strong><br />
                  Every installation leaves the world slightly better.
                </p>
              </div>
            </div>
            ...
            <div className="bg-pearl/[0.03] border border-pearl/10 rounded-3xl p-8 md:p-10 lg:p-12 space-y-6 md:space-y-8">
              <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-pearl/10 flex items-center justify-center">
                <Target className="w-7 h-7 md:w-8 md:h-8 text-pearl" />
              </div>
              <h3 className="text-2xl md:text-3xl lg:text-4xl font-light text-pearl">Our Mission</h3>
              <p className="text-base md:text-lg text-pearl/70 leading-[1.7]">
                To make clean, uninterrupted power simple and accessible — so you can focus on what matters most:
                living, creating, connecting.
              </p>
              <p className="text-sm md:text-base text-pearl/50 italic pt-4 md:pt-6 border-t border-pearl/10">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
            ...
            <div className="text-center space-y-5 md:space-y-6 p-6 md:p-8 rounded-2xl bg-pearl/[0.03]">
              <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-pearl/10 border border-pearl/10 flex items-center justify-center mx-auto">
                <Heart className="w-7 h-7 md:w-8 md:h-8 text-pearl" />
              </div>
              <h3 className="text-lg md:text-xl font-light text-pearl">Warm, not technical</h3>
              <p className="text-pearl/60 leading-[1.7] text-sm md:text-base">
            ...
            <div className="text-center space-y-5 md:space-y-6 p-6 md:p-8 rounded-2xl bg-pearl/[0.03]">
              <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-pearl/10 border border-pearl/10 flex items-center justify-center mx-auto">
                <Shield className="w-7 h-7 md:w-8 md:h-8 text-pearl" />
              </div>
              <h3 className="text-lg md:text-xl font-light text-pearl">Confident, not loud</h3>
              <p className="text-pearl/60 leading-[1.7] text-sm md:text-base">
            ...
            <div className="text-center space-y-5 md:space-y-6 p-6 md:p-8 rounded-2xl bg-pearl/[0.03]">
              <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-pearl/10 border border-pearl/10 flex items-center justify-center mx-auto">
                <Users className="w-7 h-7 md:w-8 md:h-8 text-pearl" />
              </div>
              <h3 className="text-lg md:text-xl font-light text-pearl">Inclusive, not corporate</h3>
              <p className="text-pearl/60 leading-[1.7] text-sm md:text-base">
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12 text-center relative z-10">
          ...
          <div className="space-y-12 md:space-y-16 lg:space-y-20">
            <div className="space-y-8 md:space-y-10">
              <h2 className="text-4xl md:text-6xl lg:text-7xl font-light leading-[1.1] tracking-tight px-4">
                Join the community
                <br />
                that cares.
              </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center pt-4 md:pt-8">
              <Link to="/contact/homeowner">
                <Button size="lg" className="bg-energy text-charcoal hover:bg-energy-bright px-8 md:px-10 py-5 md:py-6 text-base md:text-lg rounded-full transition-all hover:scale-105 w-full sm:w-auto">
